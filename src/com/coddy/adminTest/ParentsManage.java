...
public class ParentsManage
{
			...
			HashMap<String, String> expect)
	{
		...
		pageAction.sleep(2);
		pageAction.click("用户管理_家长管理_a");
		pageAction.sleep(2);
		pageAction.selectFrame("公共_Frame_iframe");
		pageAction.click("家长管理_所在地区_input");
		pageAction.sleep(0.5);
		pageAction.clickSubElementAsText("家长管理_所在地区列表_div", "家长管理_查询下拉列表_div",
				input.get("家长管理_所在地区"));
		pageAction.click("家长管理_学段_input");
		pageAction.sleep(0.5);
		pageAction.clickSubElementAsText("家长管理_学段列表_div", "家长管理_查询下拉列表_div",
				input.get("家长管理_学段"));
		pageAction.click("家长管理_学校名称_input");
		pageAction.sleep(0.5);
		pageAction.clickSubElementAsText("家长管理_学校名称列表_div", "家长管理_查询下拉列表_div",
				input.get("家长管理_学校名称"));
		pageAction.click("家长管理_年级_input");
		pageAction.sleep(0.5);
		pageAction.clickSubElementAsText("家长管理_年级列表_div", "家长管理_查询下拉列表_div",
				input.get("家长管理_年级"));
		pageAction.click("家长管理_班级_input");
		pageAction.sleep(0.5);
		pageAction.clickSubElementAsText("家长管理_班级列表_div", "家长管理_查询下拉列表_div",
				input.get("家长管理_班级"));
		pageAction.input("家长管理_孩子姓名_input", input.get("家长管理_孩子姓名"));
		pageAction.click("家长管理_搜索_span");
		pageAction.sleep(3);
		pageAction.clickSubElementContainsText("家长管理_家长列表行_tr", "家长管理_查看_a",
				input.get("家长管理_孩子姓名"));
		pageAction.sleep(2);
		ActionCheck.verfiyEquals(pageAction.getText("家长详情_姓名行_li").split("\n")[1],
				input.get("家长管理_家长姓名"), "查看家长详情失败");
	}
	...
	public void resetpasswordTest(HashMap<String, String> input,
			HashMap<String, String> expect)
	{
		String account = pageAction.getText("家长详情_ID行_li").split("\n")[1].trim();
		pageAction.click("家长详情_重置密码_input");
		pageAction.sleep(2);
		String message = pageAction.getText("家长详情_重置密码结果信息_div");
		String result = message.split("\n")[0];
		String newPassword = message.split("\n")[1].split(":")[1];
		ActionCheck.verfiyEquals(result, expect.get("重置密码提示"), "重置密码失败");
		pageAction.click("家长详情_提示框_确定_span");
	...
	public void lockTest(HashMap<String, String> input,
			HashMap<String, String> expect)
	{
		pageAction.click("家长详情_返回_a");
		pageAction.sleep(2);
		pageAction.input("家长管理_孩子姓名_input", input.get("家长管理_孩子姓名"));
		pageAction.click("家长管理_搜索_span");
		pageAction.sleep(3);
		pageAction.clickSubElementContainsText("家长管理_家长列表行_tr", "家长管理_锁定_a",
				input.get("家长管理_孩子姓名"));
		pageAction.sleep(2);
		pageAction.click("家长管理_锁定确认框_确定_a");
		pageAction.sleep(2);
		ActionCheck.verfiyEquals(pageAction.getText("家长管理_锁定解锁结果提示_div"),
				expect.get("锁定解锁定操作结果提示"), "家长锁定失败");
		pageAction.click("家长管理_提示框_确定_a");
	}
	...
	public void unLockTest(HashMap<String, String> input,
			HashMap<String, String> expect)
	{
		pageAction.clickSubElementContainsText("家长管理_家长列表行_tr", "家长管理_解锁_a",
				input.get("家长管理_孩子姓名"));
		pageAction.sleep(2);
		pageAction.click("家长管理_解锁确认框_确定_a");
		pageAction.sleep(2);
		ActionCheck.verfiyEquals(pageAction.getText("家长管理_锁定解锁结果提示_div"),
				expect.get("锁定解锁定操作结果提示"), "家长馆解锁失败");
		pageAction.click("家长管理_提示框_确定_a");
	}
