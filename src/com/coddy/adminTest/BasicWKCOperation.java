...
public class BasicWKCOperation
{
			...
			HashMap<String, String> expect)
	{
		...
		pageAction.sleep(2);
		ActionCheck
				.verfiyTrue(pageAction.isTextPresent2(input.get("资源分类_子类别名称")),
						"添加微课程资源失败");
	}
			...
			HashMap<String, String> expect)
	{
		...
		ActionCheck.verfiyEquals(resourceCount, "0", "删除微课程资源失败");
	}
	...
	public Object[][] testDataProvider()
	{
		return new TestDataProvider(System.getProperty("user.dir")
				...
				.getInputAndExpectData("FUN_HT_YYSHT_JCSZ_ZYFL_WK_003_1");
	}
}
